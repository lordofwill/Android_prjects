...
import com.holymoly.coronahelper.district.MyLocationService;
import com.holymoly.coronahelper.hospital.HospitalFragment;
import com.holymoly.coronahelper.infopage.InfoFragment;
import com.holymoly.coronahelper.newsfeed.NewsFragment;
import com.holymoly.coronahelper.publicmask.MaskFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public boolean locationServiceRunningCheck() {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
            if ("com.holymoly.coronahelper.district.MyLocationService".equals(service.service.getClassName())) {
                return true;
            }
        }
        return false;
