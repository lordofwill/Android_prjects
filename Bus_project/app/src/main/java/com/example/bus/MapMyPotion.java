...
public class MapMyPotion extends AppCompatActivity implements OnMapReadyCallback,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions(MapMyPotion.this, REQUIRED_PERMISSIONS,
...
//                현재 위치에 마커 생성하고 이동
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MapMyPotion.this);
